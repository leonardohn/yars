...
impl fmt::Display for Instruction {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        ...
        match self {
            ...
            LB { rd, rs1, imm } => write!(f, "lb x{}, x{}, {}", rd, rs1, imm),
            LH { rd, rs1, imm } => write!(f, "lh x{}, x{}, {}", rd, rs1, imm),
            LW { rd, rs1, imm } => write!(f, "lw x{}, x{}, {}", rd, rs1, imm),
            LBU { rd, rs1, imm } => write!(f, "lbu x{}, x{}, {}", rd, rs1, imm),
            LHU { rd, rs1, imm } => write!(f, "lhu x{}, x{}, {}", rd, rs1, imm),
            SB { rs1, rs2, imm } => write!(f, "sb x{}, x{}, {}", rs1, rs2, imm),
            SH { rs1, rs2, imm } => write!(f, "sh x{}, x{}, {}", rs1, rs2, imm),
            SW { rs1, rs2, imm } => write!(f, "sw x{}, x{}, {}", rs1, rs2, imm),
            ...
            JALR { rd, rs1, imm } => write!(f, "jalr x{}, x{}, {}", rd, rs1, imm),
            FENCE { pred, succ } => write!(f, "fence {}, {}", pred, succ),
            FENCETSO => write!(f, "fence.tso"),
            ECALL => write!(f, "ecall"),
            EBREAK => write!(f, "ebreak"),
            FENCEI => write!(f, "fence.i"),
            CSRRWI { rd, uimm, csr } => write!(f, "csrrwi x{}, {}, {}", rd, uimm, csr),
            CSRRSI { rd, uimm, csr } => write!(f, "csrrsi x{}, {}, {}", rd, uimm, csr),
            CSRRCI { rd, uimm, csr } => write!(f, "csrrci x{}, {}, {}", rd, uimm, csr),
            CSRRW { rd, rs1, csr } => write!(f, "csrrw x{}, x{}, {}", rd, rs1, csr),
            CSRRS { rd, rs1, csr } => write!(f, "csrrs x{}, x{}, {}", rd, rs1, csr),
            CSRRC { rd, rs1, csr } => write!(f, "csrrc x{}, x{}, {}", rd, rs1, csr),
